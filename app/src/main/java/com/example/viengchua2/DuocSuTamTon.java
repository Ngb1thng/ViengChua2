...
public class DuocSuTamTon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duoc_su_tam_ton);
        ...
        btnchuong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(DuocSuTamTon.this,
                        gochuong.class);
        ...
        btnmo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent2 = new Intent(DuocSuTamTon.this,
                        gomo.class);
        ...
        intent3= new Intent(DuocSuTamTon.this,kinhduocsuluulyquangvuongphat.class);
    }
    @Override
