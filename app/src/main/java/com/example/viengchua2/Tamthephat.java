...
public class Tamthephat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_the_phat);
        ...
        btnchuong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(Tamthephat.this,
                        gochuong.class);
        ...
        btnmo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent2 = new Intent(Tamthephat.this,
                        gomo.class);
        ...
        intent3= new Intent(Tamthephat.this,nhacnen.class);
